                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="ten_kich_thuoc" value="<?= isset($_SESSION['data']) ? $_SESSION['data']['ten_kich_thuoc'] : null ?>" placeholder="VD: 20 x 30 Cm" name="ten_kich_thuoc">
