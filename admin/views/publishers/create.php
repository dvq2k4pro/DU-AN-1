                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="ten_nha_xuat_ban" value="<?= isset($_SESSION['data']) ? $_SESSION['data']['ten_nha_xuat_ban'] : null ?>" placeholder="Vui lòng nhập tên nhà xuất bản" name="ten_nha_xuat_ban">
